...
# CONSTANTS
# ─────────────────────────────────────────
BRANCH_OPTIONS = ["MUMBAI", "KOTTAYAM", "COIMBATORE", "KOZHIKODE", "THRISSUR", "CHANGANACHERRY"]
...
DISPLAY_COLS = [
    ...
    "Follow up","Follow up Required?", "Follow up Date", "Feedback of Previous Follow Up", "Polymer Consumed",
]
...
FIRESTORE_TO_DISPLAY = {
    ...
    "polymer_consumed":     "Polymer Consumed",  
}
...
def show_weekly_report():
    ...
    if st.button("🔍 Generate Report", type="primary", width = 'content', key="wr_generate"):
    ...
    if df is not None and not df.empty:
        ...
        with col_mail:
            if st.button("📧 Send Email to Management", width = 'content', type="primary", key="wr_send"):
                try:
